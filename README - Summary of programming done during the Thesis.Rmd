---
title: "Thesis programming summary"
#author: "Eduardo S. Bongiolo"
#date: "March 4, 2019"
output:
  html_document:
    df_print: paged
...
Bellow is a summary of all the programming that was done to the Master Thesis.
...
#
<center> <h1>Data from other sources</h1></center>

This data was collected from external sources and used in the thesis

<center> <h2>Brazil nut price graph </h2></center>

```{r BN graph, message=FALSE, warning=FALSE, fig.align="center"}
...
#
<center> <h1>Data from the secondary forest inventories </h1></center>
<center> <h2>Data management and plotting from the inventory data </h2></center>

```{r Inventoried Data, message=FALSE, warning=FALSE, fig.align="center"}
...
<center> <h2> Model written in Python </h2></center>

```{r setup, include=FALSE}
library(reticulate)
# we need this to use Python in Rmarkdown
```

```{python Model}

# Original Python file is located in "C:\Users\eduar\OneDrive - University of Florida\Thesis\IBM_Model\IBM_FINAL_MODEL.py"
#
...
```
Data frames created were then imported to R to be managed and to created the plots

#
<center> <h1> Pos-model management and plotting </h1></center>
<center> <h2> Data management </h2></center>
<center> <h3> Basal Area </h3></center>
```{r Growth, message=FALSE, warning=FALSE, fig.align="center"}
...
```
<center> <h3> Fruit prodcutivity </h3></center>
```{r productivity, message=FALSE, warning=FALSE, fig.align="center"}
...
<center> <h2> Final map </h2></center>
```{r Map, message=FALSE, warning=FALSE, fig.align="center"}
